...
<div class="container mt-5">
        ...
        <form method="post">
            <div class="mb-3">
                ...
                <input type="text" name="instructor_id" class="form-control" value="<?= htmlspecialchars($student['instructor_id']) ?>" required>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="email" name="contact_info" class="form-control" value="<?= htmlspecialchars($student['contact_info']) ?>" required>
            </div>
